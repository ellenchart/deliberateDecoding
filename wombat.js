...
(function () {
    ...
    Storage.prototype.getItem = function getItem(name) {
        ...
        Wombat.prototype.skipWrapScriptTextBasedOnText = function (text) {
            if (!text || text.indexOf("_____WB$wombat$assign$function_____") >= 0 || text.indexOf("<") === 0)
                return true;
        ...
        Wombat.prototype.extractOriginalURL = function (rewrittenUrl) {
            ...
            return index < 0 && (index = url.indexOf("///", start)),
                index >= 0 ? url = url.substr(index + 1) : (index = url.indexOf(this.wb_replay_prefix),
                    ...
                    url !== rwURLString && !this.startsWithOneOf(url, this.VALID_PREFIXES) && (url = this.wb_orig_scheme + url)),
        ...
        Wombat.prototype.makeParser = function (maybeRewrittenURL, doc) {
            var originalURL = this.extractOriginalURL(maybeRewrittenURL)
                , docElem = doc;
            doc || (this.$wbwindow.location.href === "about:blank" && this.$wbwindow.opener ? docElem = this.$wbwindow.opener.document : docElem = this.$wbwindow.document);
        ...
        Wombat.prototype.sendTopMessage = function (message, skipTopCheck) {
            this.$wbwindow.__WB_top_frame && (skipTopCheck || this.$wbwindow == this.$wbwindow.__WB_replay_top) && this.$wbwindow.__WB_top_frame.postMessage(message, this.wb_info.top_host)
        }
        ,
        ...
        Wombat.prototype.setLoc = function (loc, originalURL) {
            ...
            loc._hash = parser.hash,
                ...
                loc._origin = parser.origin ? parser.origin : parser.protocol + "//" + parser.hostname + (parser.port ? ":" + parser.port : ""),
        ...
        Wombat.prototype.ensureServerSideInjectsExistOnWindow = function (win) {
            win && (typeof win._____WB$wombat$check$this$function_____ !== "function" && (win._____WB$wombat$check$this$function_____ = function (thisObj) {
                return thisObj && thisObj._WB_wombat_obj_proxy ? thisObj._WB_wombat_obj_proxy : thisObj
            }
            ),
                typeof win._____WB$wombat$assign$function_____ !== "function" && (win._____WB$wombat$assign$function_____ = function (name) {
        ...
        Wombat.prototype.rewriteNodeFuncArgs = function (fnThis, originalFn, newNode, oldNode) {
            ...
            return created && created.tagName === "IFRAME" && this.initIframeWombat(created),
                created
        }
        ,
            ...
            if (template._no_rewrite = true,
                ...
                if (checkEndTag) {
                    ...
                    if (first_elem) {
                        ...
                        this.endsWith(new_html, end_tag) && !this.endsWith(rwString, end_tag) && (new_html = new_html.substring(0, new_html.length - end_tag.length))
                ...
                if (string && string.indexOf("<html") >= 0)
                    ...
                    if (new_html = (headHasKids ? inner_doc.head.outerHTML : "") + (bodyHasKids ? inner_doc.body.outerHTML : ""),
                        ...
                        if (inner_doc.all.length > 3) {
                            ...
                            this.endsWith(new_html, end_tag) && !this.endsWith(string, end_tag) && (new_html = new_html.substring(0, new_html.length - end_tag.length))
        ...
        Wombat.prototype.rewriteHTMLAssign = function (thisObj, oSetter, newValue) {
            ...
            thisObj._no_rewrite || (tagName === "STYLE" ? res = this.rewriteStyle(newValue) : (res = this.rewriteHtml(newValue),
        ...
        Wombat.prototype.rewriteEvalArg = function (rawEvalOrWrapper, evalArg) {
            var toBeEvald = this.isString(evalArg) && evalArg.indexOf("_____WB$wombat$assign$function_____") === -1 ? this.wrapScriptTextJsProxy(evalArg) : evalArg;
        ...
        Wombat.prototype.overrideHistoryFunc = function (funcName) {
            ...
            var wombat = this
                , rewrittenFunc = function histNewFunc(stateObj, title, url) {
                    var rewritten_url, resolvedURL, wombatLocation = wombat.$wbwindow.WB_wombat_location;
                    if (url) {
        ...
        Wombat.prototype.initNewWindowWombat = function (win, src) {
            if (this.ensureServerSideInjectsExistOnWindow(win),
                win && !win._wb_wombat)
